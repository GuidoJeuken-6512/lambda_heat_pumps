...
<div style="display: flex; gap: 20px; align-items: flex-start; margin: 20px 0; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 300px;">
    ...
    <p>Über die Integration können die Sensoren der Lambda Wärmepumpe in Home Assistant angezeigt und die Lambda kann über die Integration gesteuert werden.</p>
    
    <p>Alle Entitäten aus der Integration können auch in Automatisierungen / Szenen usw. verwendet werden.</p>
...
<img src="assets/my_mobile_dashboard.jpg" alt="Mobile Dashboard" width="600" style="max-width: 50%; height: auto;">
